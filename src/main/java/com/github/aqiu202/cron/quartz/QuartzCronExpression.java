 ...
 */
public final class QuartzCronExpression implements Serializable, Cloneable {
     ...
     */
    public QuartzCronExpression(QuartzCronExpression expression) {
        /*
    ...
    public Date getNextInvalidTimeAfter(Date date) {
        ...
        //FUTURE_TODO: (QUARTZ-481) IMPROVE THIS! The following is a BAD solution to this problem. Performance will
        // be very bad here, depending on the cron expression. It is, however A solution.
        ...
        try {
            ...
            while (exprsTok.hasMoreTokens() && exprOn <= YEAR) {
                ...
                if (exprOn == DAY_OF_MONTH && expr.indexOf('L') != -1 && expr.length() > 1 && expr.contains(",")) {
                    throw new ParseException("Support for specifying 'L' and 'LW' with other days of the month is not" +
                            " implemented", -1);
                }
                // throw an exception if L is used with other days of the week
                if (exprOn == DAY_OF_WEEK && expr.indexOf('L') != -1 && expr.length() > 1 && expr.contains(",")) {
                    throw new ParseException("Support for specifying 'L' with other days of the week is not " +
                            "implemented", -1);
                }
    ...
    protected int checkNext(int pos, String s, int val, int type)
        ...
        if (c == 'W') {
            ...
            if (val > 31)
                throw new ParseException("The 'W' option does not make sense with values larger than 31 (max number " +
                        "of days in a month)", i);
            TreeSet<Integer> set = getSet(type);
            set.add(val);
            i++;
            return i;
    ...
    @Deprecated
    public Object clone() {
        return new QuartzCronExpression(this);
    }
}
